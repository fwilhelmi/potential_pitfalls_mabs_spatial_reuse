% FILE DESCRIPTION:
% Script to execute experiment 2.2.2 (Potential in WLANs, Env-aware approach with Thompson sampling)
...
optimalTptPerWlan = compute_optimal_throughput(wlans, optimalType, 'sim_2_2_2');
