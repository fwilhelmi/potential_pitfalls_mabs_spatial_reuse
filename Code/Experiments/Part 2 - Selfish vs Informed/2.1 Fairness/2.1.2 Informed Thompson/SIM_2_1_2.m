% FILE DESCRIPTION:
% Script to execute experiment 2.1.2 (Fairness issues in WLANs, Env-aware approach with Thompson sampling)
...
optimalTptPerWlan = compute_optimal_throughput(wlans, optimalType, 'sim_2_12');
...
[tptEvolutionPerWlan, timesArmHasBeenPlayed, estimatedRewardEvolutionPerWlan, ...
    ...
    = thompson_sampling(wlans, totalIterations, totalIterations, rewardType, ...
    sharedRewardType, convergenceActivated, 0, 0);
