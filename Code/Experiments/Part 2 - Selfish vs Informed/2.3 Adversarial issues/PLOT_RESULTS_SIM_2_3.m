...
disp('----------------------------------------------')
disp('PLOT RESULTS OF EXPERIMENT 2.3')
disp('----------------------------------------------')
...
% Load results from experiments in 2.3
load('results_experiment_2_3_1.mat');
load('results_experiment_2_3_2.mat');
load('results_experiment_2_3_3.mat');
load('results_experiment_2_3_4.mat');

% Determine the number of WLANs and iterations
num_wlans = size(tpt_evolution_2_3_1, 2);
total_iterations = size(tpt_evolution_2_3_1, 1);

% Average tpt experienced per WLAN
mean_tpt_per_wlan_selfish = mean(tpt_evolution_2_3_1(1:total_iterations,:), 1);
mean_tpt_per_wlan_shared = mean(tpt_evolution_2_3_2(1:total_iterations,:), 1);
mean_tpt_per_wlan_selfish_egreedy = mean(tpt_evolution_2_3_3(1:total_iterations,:), 1);
mean_tpt_per_wlan_shared_egreedy = mean(tpt_evolution_2_3_4(1:total_iterations,:), 1);
std_per_wlan_selfish = std(tpt_evolution_2_3_1(1:total_iterations,:), 1);
std_per_wlan_shared = std(tpt_evolution_2_3_2(1:total_iterations,:), 1);
std_per_wlan_selfish_egreedy = std(tpt_evolution_2_3_3(1:total_iterations,:), 1);
std_per_wlan_shared_egreedy = std(tpt_evolution_2_3_4(1:total_iterations,:), 1);
...
% Save Figure
figName = 'experiment_2_3_mean_tpt';
...
axis([1 20 30 70]);
subplot(2,1,1)
tpt_per_iteration_thompson = mean(tpt_evolution_2_3_1(1 : total_iterations, 1), 2);
...
set(gca,'FontSize', 22)
subplot(2,1,2)
tpt_per_iteration_egreedy = mean(tpt_evolution_2_3_3(1 : total_iterations, 1), 2);
...
set(gca,'FontSize', 22)
% Save Figure
figName = 'experiment_2_3_variability';
savefig(['./Output/' figName '.fig'])
saveas(gcf,['./Output/' figName],'png')