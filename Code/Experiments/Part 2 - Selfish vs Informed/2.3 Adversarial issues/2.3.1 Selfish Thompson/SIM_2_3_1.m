% FILE DESCRIPTION:
% Script to execute experiment 2.3.1 (Adversarial issues in WLANs, Selfish approach with Thompson sampling)
% This script partially computes the results shown in Figures 11b and 11c in Section 5.1.3
...
[tptEvolutionPerWlan, timesArmHasBeenPlayed, estimatedRewardEvolutionPerWlan, ...
    ...
    = thompson_sampling(wlans, totalIterations, totalIterations, rewardType, sharedRewardType, convergenceActivated, 0, 0);
...
plot_mabs_performance( wlans, tptEvolutionPerWlan, timesArmHasBeenPlayed, ...
    regretEvolutionPerWlan, rewardEvolutionPerWlan, rewardType, totalIterations, 'TS' )

% Save workspace
save('workspace_sim_2_3_1.mat')