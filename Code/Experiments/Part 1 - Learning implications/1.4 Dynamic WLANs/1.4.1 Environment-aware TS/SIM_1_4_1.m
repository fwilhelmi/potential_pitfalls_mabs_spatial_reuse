% FILE DESCRIPTION:
% Script to generate the results of simulation 1.4.1 (dynamic WLANs, with TS)
...
disp('----------------------------------------------')
disp('GENERATE RESULTS OF SIMULATION 1.4.1')
disp('----------------------------------------------')
...
configuration_agents_sim_1_4_1
...
optimalTptPerWlanWithoutB = compute_optimal_throughput(wlans_without_b, optimalType, 'sim_1_4_2_without_b');
...
upperBoundTpt = compute_optimal_throughput(wlans, optimalType, 'sim_1_4_2_with_b');
...
% Save Figure
save_figure( fig, 'max_min_tpt_1_4_1', './Output/' )

%% Save workspace
save('workspace_sim_1_4_1.mat')