% FILE DESCRIPTION:
% Script to generate the results of simulation 1.2.1 (Clustering benefits)
...
disp('----------------------------------------------')
disp('GENERATE RESULTS OF SIMULATION 1.2.1')
disp('----------------------------------------------')
...
configuration_agents_sim_1_2_1
...
optimalTptPerWlan = compute_optimal_throughput(wlans, optimalType, 'sim_1_2_1');
