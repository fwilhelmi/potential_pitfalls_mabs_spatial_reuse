% FILE DESCRIPTION:
% Script to generate the results of simulation 1.2.2 (Clustering benefits)
% This script partially computes the results shown in Figure 6b in Section 4.2.2
...
disp('----------------------------------------------')
disp('GENERATE RESULTS OF SIMULATION 1.2.2')
disp('----------------------------------------------')
...
configuration_system_sim_1_2
configuration_agents_sim_1_2_2
...
input_file = './Input/input_1_2.csv';
...
optimalTptPerWlan = compute_optimal_throughput(wlans, optimalType, 'sim_1_2_2');
