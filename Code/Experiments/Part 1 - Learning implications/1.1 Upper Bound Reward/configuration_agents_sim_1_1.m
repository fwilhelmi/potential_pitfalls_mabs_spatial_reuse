% FILE DESCRIPTION:
% Script for generating the agents configuration in simulation 1.1

% LEARNING ITERATIONS AND REPETITIONS
totalIterations = 100;             % Maximum convergence time (one period implies the participation of all WLANs)
