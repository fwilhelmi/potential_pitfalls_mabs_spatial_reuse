% FILE DESCRIPTION:
% Script to generate the results of simulation 1.3.2 (Clustering issues)
...
disp('----------------------------------------------')
disp('GENERATE RESULTS OF SIMULATION 1.3.2')
disp('----------------------------------------------')
...
configuration_agents_sim_1_3_2
...
optimalTptPerWlan = compute_optimal_throughput(wlans, optimalType, 'sim_1_3_2');
