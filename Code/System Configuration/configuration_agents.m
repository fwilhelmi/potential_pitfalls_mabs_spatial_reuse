% FILE DESCRIPTION:
% Script for generating the default agents configuration
...
plotResultsThompsonSampling = false;    % To plot or not the results at the end of the simulation
...
epsilonRegret = 0.05;                % Maximum allowed variability for the average cumulative regret (R_T/T) 

probabilityOfActing = 1;
clusteringActivated = false;
clusteringType = CLUSTERING_BY_SINR;
